...
namespace CrazySDK.CrazyAds.CrazyBannersDemo.DemoAssets
{
    public class CrazyBannerDemoController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            Scripts.CrazyAds.Instance.listenToBannerError(BannerError);
            Scripts.CrazyAds.Instance.listenToBannerRendered(BannerRendered);
        ...
        {
            Scripts.CrazyAds.Instance.updateBannersDisplay();
        }
